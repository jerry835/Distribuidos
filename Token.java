    ...
    while (true){
      ...
      if (nodo == 0){
        ...
        // 8.1.2 Si la variable primera_vez es false:
          ...
          contador++;
          // 8.1.2.3 Desplegar el valor de las variables nodo,contador y token.
      ...
      // 8.2 Si la variable nodo no es cero:
        ...
        contador++;
        // 8.2.3 Desplegar el valor de las variables nodo,contador y token.
      System.out.println("El valor del Nodo es: " + nodo);
      System.out.println("El valor del Contador es: " + contador);
      System.out.println("El valor del token es: " + token);
      }
      // 8.3 Si la variable nodo es cero y la varible contador es igual a 1000
      if(nodo==0 && contador==1000){
              //8.3.1 Salir del ciclo
              break;
      }
      // 8.5 Invocar el método salida.writeInt(token).    
